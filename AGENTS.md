...
- Describe operational traces as observed execution provenance. Describe reference certificates as fixed-input machine-checked equivalence, not universal proof or independent primitive-kernel verification.
