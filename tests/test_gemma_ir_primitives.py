...
class GemmaIrPrimitiveTests(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.wmma_probe = json.loads(
            (ROOT / "results" / "gemma3_270m_wmma_probe.json").read_text(
                encoding="utf-8"
            )
        )
    ...
    def test_gate_blocks_unqualified_floating_point_primitives(self) -> None:
        ...
        self.assertEqual(verification["wmma_probe_count"], 1024)
        self.assertEqual(verification["wmma_probe_distinct_result_count"], 2)
        self.assertFalse(
